...
INSERT INTO "new_Producto" ("cantidad", "categoryId", "createdAt", "description", "docena", "id", "identificador", "productId", "title", "updatedAt") SELECT "cantidad", "categoryId", "createdAt", "description", "docena", "id", "identificador", "productId", "title", "updatedAt" FROM "Producto";
DROP TABLE "Producto";
